...
\begin{frame}{Example}
  \begin{figure}
    \begin{tikzpicture}
      ...
      \draw[visible on=<2->, ->, thick] (HLOA) -- node[above, align=center]{\emph{insert "e"}\\\emph{between}\\\emph{"h" and "l"}} (HA);
      \draw[visible on=<4->, dotted] (HLOB) -- (HB);
      \draw[visible on=<4->, ->, thick] (LO.east) -- node[near end, below left, align=center]{\emph{insert "e"}\\\emph{at}\\\id{i}{B0}{0}\id{f}{A0}{0}} (HB.west);
    \end{tikzpicture}
